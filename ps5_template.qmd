...
# If the CRS are different, convert one of the datasets to match the other's CRS
# Convert zip_shapefile to the CRS of districts_gdf
...
# Step 3: Check the columns of the merged data to make sure Population column is included
print("Columns in merged_with_districts after spatial join:", merged_with_districts.columns)

# Step 4: Convert 'Population' to numeric and fill missing values (if any)
...
# Step 5: Aggregate population by district using the 'district_n' column
# If 'district_n' column is not available, use the correct column that identifies districts
population_by_district = merged_with_districts.groupby('district_n')['Population'].sum().reset_index()

# Step 6: Display the results of population aggregation
print("\nPopulation by district (first 5 rows):")
